...
\end{tabular}
\href{monroelab.org}{monroelab.org}
\end{center}
\vspace{-1em}
...
\vspace{-0.5ex}
\hspace*{1.0em} Rising Star in Organismal Botany, SICB (\$1250)\hfill2020
\vspace{1ex}\\
...
\par
\hspace*{2.0em} Evolution, New Phytologist, Theoretical and Applied Genetics, Evolutionary Applications, Scientific Reports, PLoS One, Molecular Ecology, Nucleic Acids Research, Plant Cell and Enviroment, The Plant Journal
